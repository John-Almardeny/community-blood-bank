...
<form action = "" method = "post" class="form-horizontal" >
    <fieldset><legend>Delete a Donor Record (PPS: <?php echo $PPS;?>)</legend>
	...
	<div class="col-sm-10 col-sm-offset-2">
       <input type="submit" class="btn btn-primary" value="Delete Donor Record" name = "Submit">
	 </div>
	 </div>
    </fieldset>
    </form>
